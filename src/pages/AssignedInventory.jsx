...
export default function AssignedInventory() {
	...
	return(
		...
		<SubHeader/>
		<DataTable value={newInventoryDetail} onRowEditComplete={onRowEditComplete} editMode="row" dataKey="id" size="small" tableStyle={{ minWidth: '50rem' }}>
		...
		{showDelete && <DeleteAssignedInventory showDelete={showDelete} setShowDelete={setShowDelete} id={id}></DeleteAssignedInventory>}
	</div>
	)
